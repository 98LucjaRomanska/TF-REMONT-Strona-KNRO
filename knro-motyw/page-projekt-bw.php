<?php
/*
Template Name: Projekt - bussineswoman
*/
get_header(); 
?>
...
<main id="main-content" class="container" style="padding-top: 4rem; padding-bottom: 4rem;">
    ...
    <div class="project-header">
        <div class="project-logo">
            ...
            <img src="<?php echo get_template_directory_uri(); ?>/images/logo-bw.png" alt="Logo projektu" style="width: 150px; height: 150px; object-fit: contain; background: #fff; border-radius: 20px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
        </div>
        <div class="project-intro">
            <h2 style="color: #ff5050; font-size: 2.5rem; font-family: var(--font-heading); font-weight: 700; margin-bottom: 1rem;">Bussines Woman</h2>
...
<section class="news-section project-gallery-section" style="background-color: var(--color-dark-bg); padding: 5rem 0; overflow: hidden;">
    <div class="holder">
        ...
        <div class="carousel-wrapper">
            ...
            <button class="carousel-arrow carousel-arrow--prev" aria-label="Poprzednie" onclick="przewinKaruzele('galeria-bw', -1)">&#8249;</button>
            
            <!-- Prawa strzałka podpięta pod identyfikator karuzeli -->
            <button class="carousel-arrow carousel-arrow--next" aria-label="Następne" onclick="przewinKaruzele('galeria-bw', 1)">&#8250;</button>

            <!-- Kontener kafelków z identyfikatorem id="galeria-bw" -->
            <div class="news-carousel" id="galeria-bw" role="list">
                <?php 
                $args = array(
                    'post_type'      => 'post',
                    'category_name'  => 'bw', // <--- Pamiętaj o właściwym slugu dla innych projektów
                    'posts_per_page' => 12 
                );

<?php
/*
Template Name: Projekt - Horyzont Społeczny
*/
get_header(); 
?>
...
<main id="main-content" class="container" style="padding-top: 4rem; padding-bottom: 4rem;">
    ...
    <div class="project-header">
        <div class="project-logo">
            ...
            <img src="<?php echo get_template_directory_uri(); ?>/images/logo-HSI.png" alt="Logo projektu" style="width: 150px; height: 150px; object-fit: contain; background: #fff; border-radius: 20px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
        </div>
        <div class="project-intro">
            <h2 style="color: #353535; font-size: 2.5rem; font-family: var(--font-heading); font-weight: 700; margin-bottom: 1rem;">Horyzont Społeczny</h2>
    ...
    <div class="term-bar term-bar--przydatnosc-spoleczna">
    ...
    <div class="project-coordinator">
        ...
        <div class="project-coordinator__card">
            <h3 style="color: #353535; font-family: var(--font-heading); font-size: 1.8rem; text-transform: uppercase; font-weight: 800; margin-bottom: 0.2rem;">KOORDYNATOR/KA PROJEKTU</h3>
...
<section class="news-section project-gallery-section" style="background-color: var(--color-dark-bg); padding: 5rem 0; overflow: hidden;">
    <div class="holder">
        ...
        <div class="carousel-wrapper">
            ...
            <button class="carousel-arrow carousel-arrow--prev" aria-label="Poprzednie" onclick="przewinKaruzele('galeria-horyzontspoleczny', -1)">&#8249;</button>
            
            <!-- Prawa strzałka podpięta pod identyfikator karuzeli -->
            <button class="carousel-arrow carousel-arrow--next" aria-label="Następne" onclick="przewinKaruzele('galeria-horyzontspoleczny', 1)">&#8250;</button>

            <!-- Kontener kafelków z identyfikatorem id="galeria-horyzontspoleczny" -->
            <div class="news-carousel" id="galeria-horyzontspoleczny" role="list">
                <?php 
                $args = array(
                    'post_type'      => 'post',
                    'category_name'  => 'horyzontspoleczny', // <--- Pamiętaj o właściwym slugu dla innych projektów
                    'posts_per_page' => 12 
                );

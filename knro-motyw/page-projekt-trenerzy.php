...
<main id="main-content" class="container" style="padding-top: 4rem; padding-bottom: 4rem;">
    ...
    <div class="project-header">
        ...
        <div class="project-intro">
            <h2 style="color: #4A70FF; font-size: 2.5rem; font-family: var(--font-heading); font-weight: 700; margin-bottom: 1rem;">Trenerzy</h2>
    ...
    <div class="project-coordinator">
        ...
        <div class="project-coordinator__card">
            <h3 style="color: #4A70FF; font-family: var(--font-heading); font-size: 1.8rem; text-transform: uppercase; font-weight: 800; margin-bottom: 0.2rem;">KOORDYNATOR/KA PROJEKTU</h3>
...
<section class="news-section project-gallery-section" style="background-color: var(--color-dark-bg); padding: 5rem 0; overflow: hidden;">
    <div class="holder">
        <h2 class="section-heading section-heading--light" style="text-align: center; margin-bottom: 3rem;">GALERIA ZDJĘĆ</h2>
